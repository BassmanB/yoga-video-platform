...
export function FilterBar({ initialCategory, initialLevel }: FilterBarProps) {
  ...
  return (
    <div className="mb-8 space-y-4" role="search" aria-label="Filtry wideo">
      {/* Category Pills */}
      <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide" role="group" aria-label="Filtruj po kategorii">
      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3">
        ...
        >
          <SelectTrigger className="w-full sm:w-64" aria-label="Wybierz poziom trudności">
